...
public class MainActivity extends AppCompatActivity {
    ...
    final String API_KEY = "21679527b34069ff1d4984fcba871adf";
    ...
    TextView temperature, cityName, weatherState;
...
//                super.onFailure(statusCode, headers, throwable, errorResponse);
    ...
    private void updateUI(weatherData weatherD) {
        ...
        cityName.setText(weatherD.getmCity());
        weatherState.setText(weatherD.getmWeatherType());
        int resourseId = getResources().getIdentifier(weatherD.getmIcon(), "drawable", getPackageName());
